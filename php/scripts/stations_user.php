...
if(isset($_POST['location']) && isset($_POST['radius']) || isset($_SESSION['location']) && isset($_SESSION['radius'])){
  ...
  $SITE->form_end();
  $SITE->navbar_link("Neue Suche","","reset_stations_user.php","");
  $SITE->navbar_link("Günstigste","","cheapest_station_user.php","");
  $SITE->navbar_link("Standort","","stations.php","");
  $SITE->form_search("stations_user.php","search_tag","search_tag");
  $SITE->navbar_end();
  ...
  $SITE->jumbotron_start();
  $SITE->card_deck_start();
  $SITE->add_javascript("../../js/site/user_manu.js");
  $SITE->card_deck_end();
  $SITE->jumbotron_end();
  $SITE->footer();
}
