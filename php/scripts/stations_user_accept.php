...
$SITE->header();
$SITE->add_javascript("../../js/site/geo_api.js");
$SITE->navbar_start("stations_user_accept.php");
$SITE->form("stations_user_accept.php");
...
$SITE->form_end();
$SITE->navbar_link("Neue Suche","","reset_accept.php","");
$SITE->navbar_link("Günstigste","","cheapest_accept.php","");
$SITE->form_search("stations_user_accept.php","search_tag","search_tag");
$SITE->navbar_end();
